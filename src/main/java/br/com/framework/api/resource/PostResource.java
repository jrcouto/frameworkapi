...
public class PostResource {
	...
	/*
	 * @GetMapping public Page<Post> list(Pageable pageable){ return
	 * postRepository.findAll(pageable); }
	 */
	
	@GetMapping
	public Page<Post> search(@RequestBody String textoPesquisa, Pageable pageable){ 
		return (Page<Post>) postRepository.findByText(textoPesquisa);
	} 
